...
```ts
export type IsZero<T extends number> = 
    T extends 0 ? True : False;
export type IsOne<T extends number> =   
    T extends 1 ? True : False;
...
export type NumberEqual<A extends number, B extends number> = 
    A extends B 
        ? B extends A 
            ? True
            : False
